            ...
            <div className="navivar">
                <div className="mainitem  w-auto position-relative d-flex text-center justify-content-center align-items-center">
                    <ul className='mypg d-flex '>
                        ...
                        <li className=''>
                            <a href='https://www.figma.com/file/3ePwKovJqYTbLRALUgC49p/%EA%B0%9C%EC%9D%B8%ED%8F%AC%ED%8F%B4?type=design&node-id=0%3A1&mode=dev&t=xPzE6Zru7RzJdi5P-1' target="_blank" rel="noopener noreferrer" >
